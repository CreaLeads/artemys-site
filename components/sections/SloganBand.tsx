      ...
      <div className="container-custom">
        <Reveal>
          <div className="glass-orange relative overflow-hidden rounded-[2.5rem] px-8 py-16 text-center sm:py-20">
            ...
            <p className="script-accent relative text-2xl sm:text-3xl">
              Le crayon a écrit la suite —
            </p>
            <h2 className="heading-lg relative mx-auto mt-3 max-w-3xl text-cream">
              On ne vous rend pas meilleur,{" "}
              <span className="text-orange">on vous rend irrésistible.</span>
            </h2>
