...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden pt-36 pb-20 sm:pt-44 md:pt-48">
      ...
      <div className="pointer-events-none absolute -right-20 top-28 hidden h-80 w-80 md:block">
        <div className="animate-float gpu h-full w-full">
          <div className="glass-flat glass-sheen h-full w-full rounded-full bg-gradient-to-br from-white/[0.12] to-orange/[0.06]" />
      ...
      <div className="container-custom relative">
        ...
        >
          ...
          <span className="script-accent ml-1 text-2xl">{COMPANY.baseline}</span>
        </motion.div>
